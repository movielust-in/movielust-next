...
function Wrap({ src, alt, title, description, backdrop, genres, showCard }: WrapPros) {
    ...
    const onError = () => {
        setLoading(false);
        setImgSrc(ErroredImage);
    };

    const [direction, setDirection] = useState({ x: Directions.RIGHT, h: Directions.UP });
        ...
        >
            ...
            {loading ? (
                <div className={styles.loadingImg}>
                    <img src={ColorSpinner} alt="loading" loading="lazy" />
                </div>
            ) : null}
            ...
            {showCard ? (
                <div
                    ...
                    className={`${styles.card} ${
                        direction.x === Directions.RIGHT ? styles.card_right : styles.card_left
