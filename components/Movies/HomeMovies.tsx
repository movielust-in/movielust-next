...
import { fetchPopularSeries, fetchLatestSeries, fetchTopRatedAnimes } from '../../api/tmdb/series';
...
function Movies() {
    ...
    return isLoading ? (
        <LoadingContainer>
            <img src={LoadingGhost} alt="Ghost is coming..." />
            <p>Loading...</p>
        </LoadingContainer>
    ) : (
        <Container>
            ...
            {TOTAL_NO_CAROUSELS > page && (
                <Trigger ref={ref} onClick={loadMore}>
                    <img src={ColorSpinner} alt="loading" width="10px" />
                </Trigger>
            )}
        </Container>
    );
