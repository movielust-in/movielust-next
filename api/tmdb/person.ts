...
export const fetchPerson = (id: string | number) => axios.get<Person>(PERSON(id));
...
export const fetchPeopleExternalIds = (id: string | number): Promise<PersonExternalIdsResponse> =>
    new Promise((resolve, reject) => {
        (async () => {
            try {
                const res = await axios.get<PersonExternalIdsResponse>(PEOPLE_EXTERNALIDS(id));
                resolve(res.data);
            } catch (err) {
                reject();
            }
...
export const fetchPersonImage = (id: string | number): Promise<PersonImagesResponse> =>
    new Promise((resolve, reject) => {
        (async () => {
            try {
...
export const fetchPersonTvCredits = (id: string | number): Promise<PersonTvCreditsResponse> =>
    new Promise((resolve, reject) => {
        (async () => {
            try {
